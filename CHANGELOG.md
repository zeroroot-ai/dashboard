...
## [0.120.10](https://github.com/zeroroot-ai/dashboard/compare/v0.120.9...v0.120.10) (2026-09-08)


### Bug Fixes

* **scripts:** resolve sibling repos by name, not by this workstation's tree ([#42](https://github.com/zeroroot-ai/dashboard/issues/42)) ([6fe7459](https://github.com/zeroroot-ai/dashboard/commit/6fe7459aa4f34ee657fd2325db81fc63dc981d6d))
...
* **ci:** drop the packages: read grant from both node-ci jobs ([#34](https://github.com/zeroroot-ai/dashboard/issues/34)) ([4ebc51f](https://github.com/zeroroot-ai/dashboard/commit/4ebc51f7bdf69c8f8b5f257a357ecd2033870425))

## [0.120.6](https://github.com/zeroroot-ai/dashboard/compare/v0.120.5...v0.120.6) (2026-09-08)


### Bug Fixes

* **scripts:** open each search root once in check-no-legacy-login-url ([#32](https://github.com/zeroroot-ai/dashboard/issues/32)) ([14587ed](https://github.com/zeroroot-ai/dashboard/commit/14587edf9f67fa70a264ed5223f2b8c365b12bb4))

## [0.120.5](https://github.com/zeroroot-ai/dashboard/compare/v0.120.4...v0.120.5) (2026-09-07)


### Bug Fixes

* **ci:** the audit workflow reads the Node version from .tool-versions ([#29](https://github.com/zeroroot-ai/dashboard/issues/29)) ([e3db737](https://github.com/zeroroot-ai/dashboard/commit/e3db7378fbb786e3dea510fa4fd951ad1fbbb412))
...
* **copy:** American English in prose and user-visible strings ([#1099](https://github.com/zeroroot-ai/dashboard/issues/1099)) ([2d9280c](https://github.com/zeroroot-ai/dashboard/commit/2d9280c54b224d743cd81bac5cd6893a0bb99b1b))
...
* **signup:** verify the email address before creating anything ([#991](https://github.com/zeroroot-ai/dashboard/issues/991)) ([bc6099f](https://github.com/zeroroot-ai/dashboard/commit/bc6099f642045b537cc1a2e1bd392c4c4e510910))

## [0.116.0](https://github.com/zeroroot-ai/dashboard/compare/v0.115.0...v0.116.0) (2026-08-08)
...
* **api:** restore contact-sales endpoint for the marketing site form ([#984](https://github.com/zeroroot-ai/dashboard/issues/984)) ([f40e8ed](https://github.com/zeroroot-ai/dashboard/commit/f40e8ed1baf06b72ec448e456a4e8a407d797b99))
...
* **docs:** strip the customer docs, now served by docs-site ([#987](https://github.com/zeroroot-ai/dashboard/issues/987)) ([cd62427](https://github.com/zeroroot-ai/dashboard/commit/cd624278e75deffcb65c26efce717e790f765230))
...
* **authz:** decide authorization on the object, not the relation tier alone ([#993](https://github.com/zeroroot-ai/dashboard/issues/993)) ([63fc97d](https://github.com/zeroroot-ai/dashboard/commit/63fc97da7155db159f96c43007f78b87b55c330c))
...
* **billing:** gate the trial-extension route on the cross-tenant role ([#990](https://github.com/zeroroot-ai/dashboard/issues/990)) ([1616b9f](https://github.com/zeroroot-ai/dashboard/commit/1616b9f5690713ccd20cbc269a89223d59f8723f))
...
* **build:** green the CI gates — fumadocs .source on install, @types/mdx, knip unused exports ([#958](https://github.com/zeroroot-ai/dashboard/issues/958)) ([b40b7f8](https://github.com/zeroroot-ai/dashboard/commit/b40b7f8061274fb8418425253f7bdbe5d0100f05))
...
* **dashboard:** sanitise mermaid output and stop leaking daemon errors ([#998](https://github.com/zeroroot-ai/dashboard/issues/998)) ([b93e817](https://github.com/zeroroot-ai/dashboard/commit/b93e817ec0596294b6285e9d9e9ea33ca536c2ee))
...
* **lint:** replace misplaced-disable as-any casts in MissionNodeBox.test with typed helper ([#959](https://github.com/zeroroot-ai/dashboard/issues/959)) ([b60631a](https://github.com/zeroroot-ai/dashboard/commit/b60631a83a0b3072db3ecf3295c4a61939a98a9d)), closes [#938](https://github.com/zeroroot-ai/dashboard/issues/938)
* **missions:** mapErr passes MissionDraftNotFoundError through instead of rewrapping ([#960](https://github.com/zeroroot-ai/dashboard/issues/960)) ([1bd1e9a](https://github.com/zeroroot-ai/dashboard/commit/1bd1e9a0220495d9bc3768836cd30b9e653d3aa2)), closes [#957](https://github.com/zeroroot-ai/dashboard/issues/957)
* **nav:** stop cross-origin RSC prefetch of /docs links (307 -&gt; CORS console error) ([#965](https://github.com/zeroroot-ai/dashboard/issues/965)) ([0c60e44](https://github.com/zeroroot-ai/dashboard/commit/0c60e443b25f17577b3585d460025b8dccfc2c1c)), closes [#963](https://github.com/zeroroot-ai/dashboard/issues/963)
...
* **routing:** send /docs to the docs site, not the marketing host ([#989](https://github.com/zeroroot-ai/dashboard/issues/989)) ([bcf946e](https://github.com/zeroroot-ai/dashboard/commit/bcf946e95abce3dea5e21119efef5506b4b2706a))
...
* **secrets:** validate the BYO Vault address before it is dialled ([#997](https://github.com/zeroroot-ai/dashboard/issues/997)) ([06bcda2](https://github.com/zeroroot-ai/dashboard/commit/06bcda2d99a62abb980170acf01b3550e6093393))
...
* **security:** harden the app shell, deny-by-default auth and a real CSP ([#994](https://github.com/zeroroot-ai/dashboard/issues/994)) ([bb1be27](https://github.com/zeroroot-ai/dashboard/commit/bb1be27a683f3cd7e584fd8d6af8591119f65678))
* **signup:** 240s provisioning wait + non-destructive timeout path ([#966](https://github.com/zeroroot-ai/dashboard/issues/966)) ([b8805f2](https://github.com/zeroroot-ai/dashboard/commit/b8805f2ff07e4170b7e4243fa1b427e14dccf611)), closes [#962](https://github.com/zeroroot-ai/dashboard/issues/962)
