...
* **auth:** migrate public auth surfaces to semantic tokens ([#56](https://github.com/zero-day-ai/dashboard/issues/56)) ([#72](https://github.com/zero-day-ai/dashboard/issues/72)) ([a328c5e](https://github.com/zero-day-ai/dashboard/commit/a328c5e1497ab19cb42e4da47cdecb82a472412e))
* **auth:** per-user theme cross-device sync via Zitadel user metadata (follow-up to [#57](https://github.com/zero-day-ai/dashboard/issues/57)) ([#82](https://github.com/zero-day-ai/dashboard/issues/82)) ([2212da4](https://github.com/zero-day-ai/dashboard/commit/2212da40074fdc28c5e2456622d7c4f6b69a5ba9))
...
* **ci:** no-hardcoded-colors guard with monotonic-shrink allowlist ([#53](https://github.com/zero-day-ai/dashboard/issues/53)) ([#69](https://github.com/zero-day-ai/dashboard/issues/69)) ([871ea4a](https://github.com/zero-day-ai/dashboard/commit/871ea4ab4f90f21369256a7f55bc1cb9d880403e))
* **crd:** setTenantRoleAction + setTeamAdminAction mutators ([#170](https://github.com/zero-day-ai/dashboard/issues/170)) ([2ebcef4](https://github.com/zero-day-ai/dashboard/commit/2ebcef42bef680fc9aef5a36b55880c5acad7e9c))
...
* **design:** foreground + overlay + warning tokens; drain allowlist to zero (follow-up to [#52](https://github.com/zero-day-ai/dashboard/issues/52)) ([#81](https://github.com/zero-day-ai/dashboard/issues/81)) ([3993bde](https://github.com/zero-day-ai/dashboard/commit/3993bdede2623d63d3e2d05ac8d5b69b67d6ce23))
* **design:** full light+dark token redesign + JetBrains Mono everywhere ([#52](https://github.com/zero-day-ai/dashboard/issues/52)) ([#68](https://github.com/zero-day-ai/dashboard/issues/68)) ([0ce00b3](https://github.com/zero-day-ai/dashboard/commit/0ce00b3287b4e67fff5608c9b09574a81490b349))
* **design:** import www.zero-day.ai brand tokens into dashboard ([#49](https://github.com/zero-day-ai/dashboard/issues/49)) ([b0b9205](https://github.com/zero-day-ai/dashboard/commit/b0b920573067c970a5b59f2f83608094b9067955))
* **docs:** drift guards for gibson-cli name + internal-link integrity ([#120](https://github.com/zero-day-ai/dashboard/issues/120)) ([692edde](https://github.com/zero-day-ai/dashboard/commit/692eddec422723fe43dd1ddf01504a15dca392b2))
* **docs:** migrate Fumadocs theme to design-system tokens ([#79](https://github.com/zero-day-ai/dashboard/issues/79)) ([9244e0d](https://github.com/zero-day-ai/dashboard/commit/9244e0d44c39b535a61825149cdb669b4f168a56))
* **home:** migrate landing + site-header to semantic tokens ([#54](https://github.com/zero-day-ai/dashboard/issues/54)) ([#70](https://github.com/zero-day-ai/dashboard/issues/70)) ([3c94747](https://github.com/zero-day-ai/dashboard/commit/3c94747dec3b73974daf7e2c17d3648d5c5d4375))
...
* **landing:** converge to www.zero-day.ai visual style ([#51](https://github.com/zero-day-ai/dashboard/issues/51)) ([11c8290](https://github.com/zero-day-ai/dashboard/commit/11c8290aaaa65049d0b5ab5398daf4fb82f324e5))
* **landing:** honest agent-flow security copy + extend terminology guard ([#158](https://github.com/zero-day-ai/dashboard/issues/158)) ([5bab2e6](https://github.com/zero-day-ai/dashboard/commit/5bab2e6429f87fb05912d38f3bfa89b9bf6613f7))
* **one-code-path/196:** zitadel must be reachable — delete ?? fallbacks in auth.ts + bearer verifier ([#140](https://github.com/zero-day-ai/dashboard/issues/140)) ([61f4399](https://github.com/zero-day-ai/dashboard/commit/61f439936cda2809495f473172b687cf730c87c1))
* **one-code-path/206:** dashboard required-env validator at boot ([#142](https://github.com/zero-day-ai/dashboard/issues/142)) ([c398d84](https://github.com/zero-day-ai/dashboard/commit/c398d848bc6603e9b72c227e595ee0732a50fb23))
* **one-code-path/207:** dashboard error class mapping + correlation IDs ([#141](https://github.com/zero-day-ai/dashboard/issues/141)) ([1da5e37](https://github.com/zero-day-ai/dashboard/commit/1da5e3731e4cb4624bd5bdcc9455fc2ddb9a3d90))
* **organization:** real Teams CRUD on daemon ListTeams + ListTeamMembers ([#162](https://github.com/zero-day-ai/dashboard/issues/162)) ([19ff79a](https://github.com/zero-day-ai/dashboard/commit/19ff79a4d97bab18e4b5a61d0f5859b3c55c076f))
* **pricing:** migrate pricing page to semantic + specialty tokens ([#73](https://github.com/zero-day-ai/dashboard/issues/73)) ([f14edf9](https://github.com/zero-day-ai/dashboard/commit/f14edf969d90c25582b58a1927b9dad3c14a8dd6))
* **public:** landing+pricing polish — sigils, swap, glow, copy fixes ([#109](https://github.com/zero-day-ai/dashboard/issues/109)) ([9c6fe4d](https://github.com/zero-day-ai/dashboard/commit/9c6fe4d8a2d2fb3e8dab72c951b5168098e1dbdf))
* **shell:** authenticated chrome + theme toggle ([#57](https://github.com/zero-day-ai/dashboard/issues/57)) ([#74](https://github.com/zero-day-ai/dashboard/issues/74)) ([27ac80f](https://github.com/zero-day-ai/dashboard/commit/27ac80f6e4bb577d25f80df9768d265e9a20de4c))
...
* **test:** visual baselines + auth-route session encoder ([#85](https://github.com/zero-day-ai/dashboard/issues/85)) ([e923fb4](https://github.com/zero-day-ai/dashboard/commit/e923fb417665f471b513a512fb3c7f4d2959231a))
* **test:** visual regression scaffolding for authenticated routes (follow-up to [#60](https://github.com/zero-day-ai/dashboard/issues/60)) ([#83](https://github.com/zero-day-ai/dashboard/issues/83)) ([6337f7e](https://github.com/zero-day-ai/dashboard/commit/6337f7ee67c02c8dcc395ff5da2f4ecb11838285))
* **test:** visual regression snapshot suite for public routes ([#60](https://github.com/zero-day-ai/dashboard/issues/60)) ([#80](https://github.com/zero-day-ai/dashboard/issues/80)) ([8f5dc7c](https://github.com/zero-day-ai/dashboard/commit/8f5dc7cca823577e0d01c92c4699e7bb7738e1f0))
* **users:** team-chips column + inline tenant-role dropdown ([#171](https://github.com/zero-day-ai/dashboard/issues/171)) ([1e52998](https://github.com/zero-day-ai/dashboard/commit/1e52998ee8ef6a26d17179324caa740b94b08a2f))
* **users:** team-membership editor on user detail page ([#172](https://github.com/zero-day-ai/dashboard/issues/172)) ([5dfd6d0](https://github.com/zero-day-ai/dashboard/commit/5dfd6d04b659706d8e683d42664f5d648c7c047c))
...
* **auth:** distinguish permission_denied from daemon_unavailable on error page ([#61](https://github.com/zero-day-ai/dashboard/issues/61)) ([fd6d727](https://github.com/zero-day-ai/dashboard/commit/fd6d72766718286e9cce14eebce8386b8f5da73a))
* **auth:** federated-signout uses user-flow client_id; onboarding page has signout button ([#77](https://github.com/zero-day-ai/dashboard/issues/77)) ([e793ad0](https://github.com/zero-day-ai/dashboard/commit/e793ad0c4eb240fa53aa9f967789fec3067b198d))
* **auth:** logout reads registered post-logout URI verbatim and clears active-tenant cookie ([#65](https://github.com/zero-day-ai/dashboard/issues/65)) ([158c7b0](https://github.com/zero-day-ai/dashboard/commit/158c7b039aa89ef1c15bb467801f24562e6bf4e4))
...
* check-dashboard-rbac-minimal skips clean when deploy sibling absent (closes [#166](https://github.com/zero-day-ai/dashboard/issues/166)) ([#169](https://github.com/zero-day-ai/dashboard/issues/169)) ([828d705](https://github.com/zero-day-ai/dashboard/commit/828d70500a1616087dab8c91b13b4dc5ff082958))
...
* **crd:** dual-write spec.role + FGA tuple in setTenantRoleAction ([#177](https://github.com/zero-day-ai/dashboard/issues/177)) ([f80b343](https://github.com/zero-day-ai/dashboard/commit/f80b3439e57dc7c40134e614e50516cf28865056))
* **deploy:** keep DeployLauncher visible to non-admins via AuthGatedButton ([#156](https://github.com/zero-day-ai/dashboard/issues/156)) ([99e49a4](https://github.com/zero-day-ai/dashboard/commit/99e49a4082e3a9fd5a9d53051bbd3474703f6802))
* **docs:** /docs body text readable in dark mode + visual baselines ([#110](https://github.com/zero-day-ai/dashboard/issues/110)) ([dc8a350](https://github.com/zero-day-ai/dashboard/commit/dc8a35098afcfbff50e5a6ba21100a9bba86672a))
* **docs:** absolute /docs/ links + regenerate visual baselines ([#121](https://github.com/zero-day-ai/dashboard/issues/121)) ([477d4f4](https://github.com/zero-day-ai/dashboard/commit/477d4f40a4e51a1df5336611e55bf13f73adfb2f))
* **landing,onboarding,pricing:** drain .docs-allowlist.json to zero entries ([#161](https://github.com/zero-day-ai/dashboard/issues/161)) ([3f3f32f](https://github.com/zero-day-ai/dashboard/commit/3f3f32f87b40a22a6232144a2ff8cc7972cbc77e))
...
* **layout:** server-render html.class="dark" so first paint matches the cookie ([#95](https://github.com/zero-day-ai/dashboard/issues/95)) ([1ba1bb4](https://github.com/zero-day-ai/dashboard/commit/1ba1bb4f7bc768432a5cbc8ea38fbb3ea5416bbb))
* **organization:** move pages into authenticated app shell, fix sidebar 404s ([#155](https://github.com/zero-day-ai/dashboard/issues/155)) ([61d6388](https://github.com/zero-day-ai/dashboard/commit/61d6388771f9e18594e6ada11107652deab7afdc))
...
* **signup:** inline workspace-name availability + "Company Name" label ([#62](https://github.com/zero-day-ai/dashboard/issues/62)) ([a6ee727](https://github.com/zero-day-ai/dashboard/commit/a6ee7278e79c5bc434bfe5788c5b2dbbd566db0c))
* **tests:** unbreak pnpm typecheck — align test mock types with production signatures ([#67](https://github.com/zero-day-ai/dashboard/issues/67)) ([6206a56](https://github.com/zero-day-ai/dashboard/commit/6206a569fcd5eadec8ae403c8713e66004c63588)), closes [#66](https://github.com/zero-day-ai/dashboard/issues/66)
