...
import type { JobSpec } from "../../job/v1/job_pb";
import { file_gibson_job_v1_job } from "../../job/v1/job_pb";
import type { Task, TaskConstraints } from "../../types/v1/types_pb";
 ...
 *
 * @generated from message gibson.mission.v1.JobNodeConfig
 */
export type JobNodeConfig = Message<"gibson.mission.v1.JobNodeConfig"> & {
  /**
   * bank_ref names the bank to open the job on, by id or by name.
   * Required.
   *
   * @generated from field: string bank_ref = 1;
   */
  bankRef: string;
   ...
   *
   * @generated from field: gibson.job.v1.JobSpec spec = 2;
   */
  spec?: JobSpec;
   ...
   *
   * @generated from field: gibson.types.v1.TaskConstraints constraints = 3;
   */
  constraints?: TaskConstraints;
};

/**
 * Describes the message gibson.mission.v1.JobNodeConfig.
