 ...
 * at the root. That cookie is set client-side by
 * `signIn("zitadel", { callbackUrl })`, which can race, get stripped by a
 * strict cookie policy, or simply be skipped (user navigates straight to
