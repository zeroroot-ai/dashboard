 ...
 */
export type Principal = Message<"gibson.common.v1.Principal"> & {
  /**
   * kind is the class of principal.
   *
   * @generated from field: gibson.common.v1.Principal.Kind kind = 1;
   */
  kind: Principal_Kind;
...
/**
 * Describes the message gibson.common.v1.Principal.
 ...
 *
 * @generated from enum gibson.common.v1.Principal.Kind
 */
export enum Principal_Kind {
  /**
   ...
   *
   * @generated from enum value: KIND_TENANT = 2;
   */
  TENANT = 2,
   ...
   * principal id.
   *
   * @generated from enum value: KIND_COMPONENT = 3;
   */
  COMPONENT = 3,
   ...
   *
   * @generated from enum value: KIND_SERVICE = 4;
   */
  SERVICE = 4,
}
