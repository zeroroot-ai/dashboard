...
const VALID_ENV: Record<string, string> = {
  ...
  AUTH_SECRET: 'Qk7pR2xLmZ9vTc4WnB6yHd8sJf3gAe5U', // gitleaks:allow — test fixture, must look generated
...
describe('env-validator: validateEnv()', () => {
  ...
  it('rejects an AUTH_SECRET below the minimum length', () => {
    expect(malformedNames({ AUTH_SECRET: 'Qk7pR2xLmZ9vTc4WnB6y' })).toContain( // gitleaks:allow — test fixture
      'AUTH_SECRET',
    );
  });
  ...
  it('accepts a generated-looking AUTH_SECRET', () => {
    expect(
      malformedNames({ AUTH_SECRET: 'kJ8vN2pQ7mR4tW9xZ3bY6cF1gH5dS0aL' }), // gitleaks:allow — test fixture
